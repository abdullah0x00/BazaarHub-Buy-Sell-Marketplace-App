...
class _AdminAnalyticsScreenState extends State<AdminAnalyticsScreen> {
  ...
  Widget _buildSummaryGrid() {
    return GridView.count(
      ...
      children: [
        _StatBox(label: 'Gross Revenue', value: 'PKR ${_fmt(_analytics?['totalRevenue'] ?? 0)}', icon: Icons.payments_rounded, color: Colors.green),
        _StatBox(label: 'Total Orders', value: '${_analytics?['totalOrders'] ?? 0}', icon: Icons.shopping_cart_rounded, color: Colors.blue),
